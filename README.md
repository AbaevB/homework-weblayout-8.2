...
### Внесение правок по замечаниям куратора

- Фоновое изображение в секции hero заменено контентным

- Добавлены БЭМ компоненты shield и arc

- Маркированный список с цветными маркерами сделан компонентом *bulleted-list*

- Добавлены адаптивные картинки для всех разрешений
